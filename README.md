# NTPU Student Congress Cloud

## 專案介紹

NTPU Student Congress Cloud 是國立臺北大學學生議會（三峽校區）秘書處為了方便學生自治會各單位維護法規等資料使用。這個系統最初為了輔助[會網](https://ntpusu.org)法規查詢功能而生，後來也加上列印功能（方便公告與製作紙本法規彙編）。
